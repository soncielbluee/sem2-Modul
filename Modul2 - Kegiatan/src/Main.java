...
class Main {
    static Book[] bookList = {
            new Book(1, "Bad Guy", "Dooms", "Comedy"),
            new Book(2, "How To Fight", "Taejoon Park", "Action"),
            new Book(3, "Iseop' Romance", "Anna Kim", "Romance"),
            new Book(4, "The Real Lesson", "Chae Youngtaek", "Action"),
            new Book(5, "Study Group", "Hyungwuk Shin", "Action"),
    };
...
class Student extends User {
    ...
    void displayBorrowedBooks() {
        ...
        for (Book book : borrowedBooks) {
            ...
            System.out.println("Penulis Buku: " + book.author);
            System.out.println("Kategori Buku: " + book.category);
            System.out.println();
        }
    }
